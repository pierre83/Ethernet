...
{
  static float pps_max = 0, pps_moy = 0, pps_min = 9999, speed_max = 0, speed_moy = 0;
  ...
  Serial.print(F("Pkt OK\t"));      Serial.print(count);  Serial.print(F(", Fail\t"));    Serial.println(failed);
  pps_moy += pps;
  speed_moy += speed;
  ...
  if ( combien == MAX_COUNT) {
    ...
    Serial.print(F("Mid rate: "));    Serial.print(speed_moy / MAX_COUNT, 0);   Serial.println(F(" Bytes/sec"));
    Serial.print(F("PPS max : "));    Serial.print(pps_max, 1 );    Serial.println(F(" pps"));
    Serial.print(F("PPS moy : "));    Serial.print(pps_moy / MAX_COUNT, 1 );    Serial.println(F(" pps"));
    Serial.print(F("PPS min : "));    Serial.print(pps_min, 1 );    Serial.println(F(" pps"));
    Serial.print(F("PKT ok  : "));    Serial.print(packetCount);    Serial.print(F(", fail: "));    Serial.println(fail);
    Serial.println();
    pps_max = 0, pps_min = 9999, speed_max = 0, speed_moy = 0, pps_moy = 0 ;
