...
// Parameters must be IDENTICAL on the SENDER side:
...
void udp_send(const char * buf, const uint8_t len)
{
  ...
  Serial.print(F("Packets: "));    Serial.print(goodpackets);         Serial.println(F(" %"));
  //Serial.print(F(" / "));          Serial.print(ITERATIONS); 
  Serial.print(F("Bytres : "));      Serial.print(bytespackets);         Serial.println(F(" %"));
