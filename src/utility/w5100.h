...
// Default values, maybe not convenient for you: change as desired
#if defined(__AVR__)	// Uno, Mega, Nano, etc..
	// Safe for all chips
...
public:
  ...
  static const uint8_t IGMP   = 0x20;
};
...
public:
  ...
  static uint8_t getLinkStatus(uint8_t whichOne);
